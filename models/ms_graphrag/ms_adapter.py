...
class MSGraphRAGAdapter:
    ...
    async def local_search(self, query: str) -> tuple[str, list, list]:
        ...
        response, context_data = await gapi.local_search(
            ...
            # The primary path must pass the persisted upstream artifact
            # through unchanged. In particular, do not synthesize singleton
            # memberships for entities omitted by native clustering.
