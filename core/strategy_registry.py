...
STRATEGIES = (
    ...
    StrategySpec(
        ...
        paper_index_policy=(
            ("extraction_validation_profile", "strict-ms-native-glean-v4"),
    ...
    _external(
        ...
        paper_index_policy=(
            ...
            ("qa_top_k", 5),
            ("openie_mode", "online"),
            ("semantic_config_id", "hipporag2-paper-strict-extraction-v5"),
        ...
        paper_index_environment=(
            ...
            ("retrieval_top_k", "RAG_HIPPORAG2_TOP_K", 200),
    ...
    _external(
        ...
        paper_index_policy=(
            ("semantic_config_id", "youtu-native-agent-v4"),
