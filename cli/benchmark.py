        ...
        results, resume_metadata = _resume_benchmark_rows(
            ...
            benchmark_data,
            {
                ...
                "ablation": {
                    ...
                    **({"chunk_sentences": RAGConfig.CHUNK_SENTENCES} if strategy == "prehop" else {}),
                    **({"naive_retrieval_unit": "source_document"} if strategy == "naive" else {}),
                    ...
                    "naive_top_k": RAGConfig.NAIVE_TOP_K,
