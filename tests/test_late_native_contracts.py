...
os.environ.update(RAG_PAPER_MODE='true',RAG_INFERENCE_BASE_URL='http://litellm.test/v1',RAG_INFERENCE_API_KEY='synthetic',RAG_GENERATION_MODEL='gemma-4-31b-it',RAG_EMBEDDING_MODEL='qwen3-embedding-8b',RAG_LLM_SEED='42')
