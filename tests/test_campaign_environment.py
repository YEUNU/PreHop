...
os.environ.update(RAG_INFERENCE_BASE_URL='http://gateway.test/v1',RAG_INFERENCE_API_KEY='synthetic',RAG_GENERATION_MODEL='gemma-4-31b-it',RAG_EMBEDDING_MODEL='qwen3-embedding-8b')
